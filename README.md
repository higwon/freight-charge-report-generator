...
- 월별보고서 Overview에는 전체 KPI, 코드별 요약, 월별 요약, 매출·매입 상위 Port/Customer, 검토 대상, 차트가 포함됩니다.
- 각 코드별 시트에는 코드 전체 월별 요약, 거래처별 누적 요약, 매출·매입 Top 5가 포함됩니다.
...
누적 금액 순위
매출 상위 Port | 매입 상위 Port | 매출 상위 Customer | 매입 상위 Customer
